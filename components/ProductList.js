      ...
      <div className="relative z-10 p-8 max-w-7xl mx-auto">
        ...
        <header className="flex flex-col sm:flex-row justify-between items-center mb-12 pt-6">
          <div>
            ...
            <p className="text-cyan-300 text-lg">🛍️ Manage Your Inventory</p>
          </div>
          <a
            href={`/products/create`}
            className="mt-6 sm:mt-0 px-8 py-4 bg-gradient-to-r from-cyan-500 via-purple-500 to-pink-500 text-white rounded-xl hover:shadow-2xl hover:shadow-cyan-400/50 transition-all duration-300 font-bold shadow-lg transform hover:scale-105 flex items-center gap-2"
          >
        ...
        <div className="mb-10">
          <div className="relative max-w-2xl mx-auto">
            ...
            />
            <svg className="absolute left-5 top-1/2 transform -translate-y-1/2 w-6 h-6 text-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {currentProducts.length ? (
          <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-12">
            {currentProducts.map((p, index) => (
              ...
              >
                <a href={`/products/${p.id}`} className="block relative overflow-hidden h-56 w-full bg-gradient-to-br from-slate-800 to-slate-900">
                  <img
          ...
          <div className="flex items-center justify-center py-20">
            <div className="bg-slate-900/50 backdrop-blur-xl border border-cyan-400/30 rounded-3xl shadow-2xl p-12 text-center">
              ...
              <p className="text-2xl text-cyan-300 font-semibold">No products found</p>
        ...
        <div className="flex justify-center items-center gap-4 pb-12">
          ...
          <div className="px-6 py-3 bg-gradient-to-r from-cyan-500/20 via-purple-500/20 to-pink-500/20 backdrop-blur-sm border border-cyan-400/30 rounded-xl">
            <span className="font-bold text-white">
              Page <span className="text-cyan-400">{currentPage}</span> of <span className="text-purple-400">{totalPages}</span>
            </span>
          </div>
